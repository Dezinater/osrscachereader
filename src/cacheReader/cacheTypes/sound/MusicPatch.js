...
export default class MusicPatch {
    ...
    field2772;
    rawSounds = new Array(128);
    field2771 = new Array(128);
    field2773 = new Array(128);
    field2774 = new Array(128);
    field2775 = new Array(128);
    field2776 = new Array(128);
    field2777 = new Array(128);
    ...
    constructor(var1) {
        ...
        let var3;
        for (var3 = 0; var2.getUint8(var3 + var2.getPosition()) != 0; ++var3) {
            ;
        }
        ...
        let var6;
        for (var6 = 0; var2.getUint8(var6 + var2.getPosition()) != 0; ++var6) {
            ;
        }
        ...
        let var9;
        for (var9 = 0; var2.getUint8(var9 + var2.getPosition()) != 0; ++var9) {
            ;
        }
        ...
        for (var14 = 0; var14 < var39.length; ++var14) {
            ...
            if (var16 > 0) {
                var40.field2718 = new Array(var16 * 2).fill(0);
            }

            var16 = var2.readUint8();
            if (var16 > 0) {
                var40.field2717 = new Array(var16 * 2 + 2).fill(0);
        ...
        let var17;
        for (var17 = 0; var2.getUint8(var17 + var2.getPosition()) != 0; ++var17) {
            ;
        }
        ...
        for (var23 = 0; var23 < 128; ++var23) {
            ...
            this.field2771[var23] = (this.field2771[var23] + ((var22 - 1 & 2) << 14));
        ...
        this.field2772 = var2.readUint8() + 1;
        ...
        if (var47 != null) {
            for (var27 = 1; var27 < var47.length; var27 += 2) {
                var47[var27] = var2.readInt8();
            }
        }

        if (var41 != null) {
            for (var27 = 1; var27 < var41.length; var27 += 2) {
                var41[var27] = var2.readInt8();
            }
        }
        ...
        for (var27 = 0; var27 < var12; ++var27) {
            var39[var27].field2719 = var2.readUint8();
        }

        for (var27 = 0; var27 < var12; ++var27) {
            var28 = var39[var27];
            if (var28.field2718 != null) {
                var28.field2720 = var2.readUint8();
            }

            if (var28.field2717 != null) {
                var28.field2725 = var2.readUint8();
            }

            if (var28.field2719 > 0) {
                var28.field2722 = var2.readUint8();
            }
        }

        for (var27 = 0; var27 < var12; ++var27) {
            var39[var27].field2724 = var2.readUint8();
        }

        for (var27 = 0; var27 < var12; ++var27) {
            var28 = var39[var27];
            if (var28.field2724 > 0) {
                var28.field2723 = var2.readUint8();
            }
        }
        ...
        for (var27 = 0; var27 < var12; ++var27) {
            ...
            if (var28.field2723 > 0) {
                var28.field2721 = var2.readUint8();
            }
        }
